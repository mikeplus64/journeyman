...
\begin{enumerate}
\item Run the existing Elo-driven simulator repeatedly for a particular tournament
structure.
\item Taking into account changes in Elo that happened throughout the course of the
...
\item Do the same for other tournament structures, with the same initial Elo
...
was not clear what the correct semantics \emph{should} be to be tested for in the first
place.

\newpage

\section{References}
\label{sec:org2972096}
