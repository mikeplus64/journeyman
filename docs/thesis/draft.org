...
- Sequences
- Focuses
- Swapping vs point-awards, hint at section below for what tournaments are
  traditional sorting networks and what are not
...
*** Which tournaments are sorting networks and which are not?
